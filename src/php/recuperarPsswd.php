...
if ($creacionToken == true) {
    ...
    $link .= "<a href='http://music-life.es/src/php/cambiarPsswd.php?token=$token' style='background-color: #95C8FF; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;'>Cambiar contrasena</a></div>";
