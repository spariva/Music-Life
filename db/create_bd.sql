...
CREATE TABLE PLAYLISTS(
  ID NUMBER(6) CONSTRAINT PK_PLAYLISTS PRIMARY KEY,
  NOMBRE VARCHAR2(26) NOT NULL,
  CREADOR_ID NUMBER(6) NOT NULL,
  CANCION_ID NUMBER(6) NOT NULL,
...
CREATE TABLE COMENTARIOS(
  ...
  CONSTRAINT FK_PLAYLISTID_COM FOREIGN KEY (PLAYLIST_ID) REFERENCES PLAYLIST(ID) ON DELETE CASCADE
);
