-- CREATE DATABASE musicLifeDatabase; ACTUALMENTE USAMOS USER, PLAYLIST Y COMENTARIOS
...
CREATE TABLE PLAYLIST(
  ...
  FOREIGN KEY (USER_NAME) REFERENCES USER(NAME) ON DELETE CASCADE --no tiene sentido guardar el creator id si no podemos crear desde nuestra web.
);
...
CREATE TABLE COMENTARIOS(
    ...
    FOREIGN KEY (PLAYLIST_ID) REFERENCES PLAYLIST(LINK) ON DELETE CASCADE
);
