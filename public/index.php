				...
				<div id="buscador">
					<div id="lupaBuscador">
						<div id="barraBusqueda" class="barraBusqueda">
							<form id="buscador2" aria-label="Botón de búsqueda de playlists" action="subirValoracion.php">
							...
							<iframe id="iframeBusqueda" style="border-radius:12px"
								...
								<div class="contenedorSoporteParaValoraciones w-100">
									...
									<form action="./subirValoracion.php" method="post">
										<div class="ratingBlock">
											<input type="hidden" name="username" value="<?php if (isset($_SESSION['user'])) {
												echo $_SESSION['user']; 
											}?>">
